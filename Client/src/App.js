...
import TestingAuth from "./components/TestingAuth/TestingAuth";
import NoAuthorized from "./components/Common/NoAuthorized/NoAuthorized";
  ...
  return (
    <>
      <Switch>
        ...
        <Route path="/testingAuth" exact component={TestingAuth} />
        ...
        <Route path="/external" exact component={NoAuthorized} />
        {/* <Route
          path="/external"
          component={() => {
            window.location =
